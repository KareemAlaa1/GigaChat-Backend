 ...
 * @throws Will throw an error if there are no hashtags found in the database.
 * @throws Will also throw an error if there is an issue with the database query.
 * @returns {Object} res - The response object containing the status of the request and the data (hashtags) if successful.
 */
 ...
 * @throws Will throw an error if the hashtag is not found or if there are no tweets associated with the hashtag.
 * @throws Will also throw an error if there is an issue with the database query.

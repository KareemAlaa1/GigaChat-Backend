...
describe('Follow Endpoint', () => {
    it('should follow a user successfully', async () => {
        ...
        expect(updatedUser0.followingUsers[0].toString()).toContain(testUser1._id.toString());
        expect(updatedUser1.followersUsers[0].toString()).toContain(testUser0._id.toString());
    });
...
describe('Like Tweet', () => {
    it('should like a tweet successfully', async () => {
        ...
        expect(updatedTweet.likersList[0].toString()).toBe(testUser0._id.toString());
        expect(updatedUser.likedTweets[0].toString()).toBe(testTweet._id.toString());
    });
    ...
    it('should handle case where the user already liked the tweet', async () => {
        ...
        const response = await request(app)
            ...
            .expect(400)
            .expect((res) => {
                expect(res.body.error).toBe('Bad request, User already like this tweet');
            });
    });
